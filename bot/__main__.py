...
def start(update, context):update
    buttons = ButtonMaker()
    buttons.buildbutton("🔥Repo🔥", "https://github.com/Professor445/leeche")
    buttons.buildbutton("😍Channel", "https://t.me/leechertamilan")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
This is a ☠Mirror and leech bot☠
